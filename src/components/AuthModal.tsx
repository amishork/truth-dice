      ...
      >
        ...
        >
          ...
          {confirmationSent ? (
            ...
            <>
              {/* Social login buttons — hidden until OAuth providers are configured in Supabase */}
              {/* To re-enable: remove the false && gate below and configure Google/Apple/Facebook in Supabase Auth settings */}
              {false && (
                <>
