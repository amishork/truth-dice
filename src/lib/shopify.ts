...
export const SHOPIFY_STOREFRONT_TOKEN = import.meta.env.VITE_SHOPIFY_STOREFRONT_TOKEN || '34c438630f503de5b7b32e80feb6fa38';
...
export async function storefrontApiRequest(query: string, variables: any = {}) {
  ...
  if (response.status === 402) {
    throw new Error('Shopify: Payment required. Please upgrade your Shopify plan.');
  }
