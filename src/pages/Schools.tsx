          ...
          <div className="container mx-auto px-4">
            <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
                Every engagement is scoped to your school's size, needs, and budget. From
                a single faculty workshop to a full-year transformation partnership.
              </p>
              <div className="mt-10 grid gap-6 sm:grid-cols-3">
                {[
                  { tier: "Workshop", price: "$1,200+", desc: "Half-day faculty or student session" },
                  { tier: "Semester", price: "$3,500+", desc: "Multi-session formation program" },
                  { tier: "Full Year", price: "$8,000+", desc: "Comprehensive culture transformation" },
                ].map((t, i) => (
                  <motion.div
                    key={t.tier}
                  ...
                  >
                    <p className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">{t.tier}</p>
                    <p className="mt-2 text-2xl font-semibold text-foreground">{t.price}</p>
